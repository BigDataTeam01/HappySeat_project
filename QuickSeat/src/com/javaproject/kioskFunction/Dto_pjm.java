...
public class Dto_pjm {
	...
	public Dto_pjm(String movie_title, String director, String genre, Date rel_date, String film_rating, String made_in, String rel_status) {
	...
	public Dto_pjm(String director, String movie_title,  String actor, String dist_company, String genre,
